 ...
 */
public class BrandListImageAdapter extends BaseAdapter{
    private Activity activity;
    LayoutInflater inflater;
    Context mContext;
    private List<Product> productList;
    private ArrayList<Product> arraylist;
    private String TAG = BrandListImageAdapter.class.getSimpleName();
    private Bitmap b;
    private DisplayImageOptions options;

    //private String[] bgColors;

    public BrandListImageAdapter(Context context, List<Product> productList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            convertView = inflater.inflate(R.layout.list_image_brand,null);
            holder.productImage = (ImageView) convertView.findViewById(R.id.productImage);
            holder.progressBar = (ProgressBar) convertView.findViewById(R.id.progress);
            holder.iconNew = (ImageView)convertView.findViewById(R.id.iconNewBrand);
